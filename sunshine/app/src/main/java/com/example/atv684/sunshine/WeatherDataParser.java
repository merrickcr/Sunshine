...
public class WeatherDataParser {
    ...
    public static double getMaxTemperatureForDay(String weatherJsonStr, int dayIndex){
        ...
        try{
            ...
            JSONArray listJson = json.getJSONArray(LIST_KEY);
            JSONObject entry = listJson.getJSONObject(dayIndex);
            JSONObject temp = entry.optJSONObject(TEMP_KEY);

            Double maxTemp = temp.optDouble(MAX_KEY);
